<template>
  <div class="course-page">
    <el-card>
      ...
      <el-table :data="courses" v-loading="loading" stripe>
        ...
        <el-table-column label="价格" width="90" align="center">
          <template #default="{ row }">
            <span v-if="row.price > 0">¥{{ row.price.toFixed(0) }}</span>
    ...
    <!-- 创建课程对话框 -->
    <el-dialog v-model="createDialogVisible" title="创建公共课" width="560px" top="5vh">
    ...
    <!-- 编辑课程对话框 -->
    <el-dialog v-model="editDialogVisible" title="编辑课程" width="560px" top="5vh">
