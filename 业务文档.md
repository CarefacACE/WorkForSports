...
- **AI 智能助手**（LangChain4j + DeepSeek、SSE 流式对话、6个业务工具：排课/余额/运动/健康/签到/课程查询、AI生成训练计划）
...
```json
{
  "code": 200,
  "message": "success",
  "data": ["sys_user", "sys_log", "course", "lesson", "enrollment", "wallet_transaction", "course_schedule", "exercise_record", "member_health_profile", "sys_file", "check_in_record", "agent_chat_message", "gym_card", "gym_membership", "private_coach_profile"]
}
```
