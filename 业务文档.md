...
| `/member/schedule` | member-schedule | MemberScheduleView.vue | 继承父路由守卫 |
...
| `/coach/schedule` | coach-schedule | CoachScheduleView.vue | 继承父路由守卫 |
...
- 服务端口: 8080
- 上下文路径: /api
- 数据库: jdbc:mariadb://localhost:3366/fzqsdata
- 连接池: Druid (最小5, 最大20)
...
如需手动初始化：
```sql
CREATE DATABASE IF NOT EXISTS fzqsdata CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
```
